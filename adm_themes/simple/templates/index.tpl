...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{$urlTheme}/images/favicon.ico" sizes="32x32" />
...
<body id="{$id}" class="admidio">
    ...
    <nav class="navbar fixed-top navbar-light navbar-expand flex-column flex-md-row bd-navbar" id="admidio-main-navbar">
        <a class="navbar-brand" href="{$urlAdmidio}/adm_program/overview.php">
            <img class="d-none d-md-block align-top" src="{$urlTheme}/images/apple-touch-icon.png"
                alt="{$l10n->get('SYS_ADMIDIO_SHORT_DESC')}" title="{$l10n->get('SYS_ADMIDIO_SHORT_DESC')}" width="100" height="80">
        </a>
